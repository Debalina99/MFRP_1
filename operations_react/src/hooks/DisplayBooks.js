...
class DisplayEmployeesBook extends React.Component{
    constructor() {
        super();
        ...
        return (
            <div className="">
                ...
                <input type="text" id="myInput" onKeyUp={()=>this.myFunction()} className="rounded col-md-5"
                        placeholder="Search for book names.." title="Type in a name">
                        </input>
                </div>
                <div className="avbooks">Available Books
                </div>
...
export default DisplayEmployeesBook;